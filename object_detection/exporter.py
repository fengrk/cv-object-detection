...
def _write_saved_model(saved_model_path,
    ...
    Args:
      saved_model_path: Path to write SavedModel.
      trained_checkpoint_prefix: path to trained_checkpoint_prefix. such as /path/to/model.ckpt
...
def _export_inference_graph(input_type,
                            ...
                            saved_model_with_variables=False):
    """Export helper."""
    ...
    if saved_model_with_variables:
        _write_saved_model(saved_model_path, checkpoint_to_use, placeholder_tensor, outputs)
    else:
...
def export_inference_graph(input_type,
    ...
    Args:
      ...
      saved_model_with_variables: If true, create SavedModel with variables.
    """
    ...
    _export_inference_graph(
        ...
        saved_model_with_variables=saved_model_with_variables,
    )
